                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample row" action="{{ route('admin.banner_update', ['id' => $banner->id]) }}" method="post" enctype="multipart/form-data">
                        ...
                        <input type="text" class="form-control" name="title" id="exampleInputName1" placeholder="Title" value="{{$banner->title}}">
                        @error('title')
                      ...
                      <div class="form-group col-6">
                        ...
                        @error('image')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                        <img style="width:70px;margin-top:5px" src="{{ asset('uploads/banners/'.$banner->image) }}" >
                      </div>
                      <div class="form-group">
                        <label for="exampleTextarea1">Sub Titile</label>
                        <textarea class="form-control" id="exampleTextarea1" rows="4" name="sub_titile">{{$banner->subtitle}}</textarea>
                        @error('sub_titile')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                      </div>
